...
def get_scheduler(params, optimizer, rate=1.0, decay=0.99, max_learning_rate=1e4, epsilon=1e-6):
    scheduler = None
    if optimizer == 'sgd':
...
def minimize(inputs, loss, params, optimizer='sgd', is_softmax=False, rate=1.0, decay=0.99, max_learning_rate=1e4, epsilon=1e-6):
